...
PERSISTED_CONTROL_TRAITS = ["mode", "br_intensity", "br_wavelength", "br_frequency", "br_gain", "br_exposure", "fl_intensity", "fl_wavelength", "fl_frequency", "fl_gain", "fl_exposure", "device_viewer_stream"]
